...
/*!*****************************!*\
  !*** ./Day1/src/helpers.js ***!
  \*****************************/
/*! exports provided: reachesFrequencyTwice */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"reachesFrequencyTwice\", function() { return reachesFrequencyTwice; });\nfunction parseData(inputData) {\n  inputData = inputData.split(\"\\n\");\n  return inputData;\n}\n\nfunction reachesFrequencyTwice(inputData) {\n  var frequencyChangesArray = parseData(inputData);\n  var resultingFrequency = 0;\n  var resultingFrequenciesSet = new Set();\n  var counter = 0; //while the set doesn't have the resulting frequency already\n\n  while (!resultingFrequenciesSet.has(resultingFrequency)) {\n    //add current resulting frequency to the set\n    resultingFrequenciesSet.add(resultingFrequency); //change current resulting frequency\n\n    resultingFrequency += parseInt(frequencyChangesArray[counter]); //increment the counter\n\n    counter++; //if the counter equals the array length - reset it (start looping again)\n\n    if (counter === frequencyChangesArray.length) {\n      counter = 0;\n    }\n  }\n\n  return resultingFrequency;\n}\n\n//# sourceURL=webpack:///./Day1/src/helpers.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./data */ \"./Day1/src/data.js\");\n/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ \"./Day1/src/helpers.js\");\n\n //First part\n\nconsole.log(\"Answer to the first part is: \" + _data__WEBPACK_IMPORTED_MODULE_0__[\"INPUT_DATA_PART_ONE\"]); //Second part\n\nconsole.log(\"Answer to the second part is: \" + Object(_helpers__WEBPACK_IMPORTED_MODULE_1__[\"reachesFrequencyTwice\"])(_data__WEBPACK_IMPORTED_MODULE_0__[\"INPUT_DATA_PART_TWO\"]));\n\n//# sourceURL=webpack:///./Day1/src/main.js?");
